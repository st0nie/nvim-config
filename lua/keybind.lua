...
keymap("n", "<leader>[t", "<cmd>FloatermPrev<CR>", { silent = true })
keymap("n", "<leader>]t", "<cmd>FloatermNext<CR>", { silent = true })
keymap("n", "<leader>tn", "<cmd>FloatermNew<CR>", { silent = true })
keymap("n", "<leader>tk", "<cmd>FloatermKill<CR>", { silent = true })
